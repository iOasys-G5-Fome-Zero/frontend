...
const ProducersSection = () => {
  ...
  return (
    <S.Container>
      <h2>Produtores</h2>
      <h5>
        Conheça nossos produtores credenciados, são eles que produzem e levam o
        alimento até a sua mesa. Assinando com o Cestou você fortalece a
        produção de pequenos produtores da sua região e recebe alimentos frescos
        e cultivados com muito carinho e cuidado.
      </h5>
      ...
      <h5>
        Os produtos produzidos pelos agricultores familiares são especiais
        porque carregam a história de quem os produziu, o respeito pela natureza
        e, principalmente o esmero na escolha e beneficiamento dos ingredientes
        na alimentação diária de sua família. De família pra famílias!
      </h5>
    </S.Container>
  );
};
