...
const DonationsSection = () => {
  ...
  return (
    <S.Container donations={donations} barFill={(donations / target) * 100}>
      ...
      <h5>
        Acompanhe abaixo o recebimento de doações do mês, realizadas através de
        doações dos nossos assinantes de cestas pelo app.
      </h5>
      ...
      <h5>
        A cada mês seu saldo de Horticoins será creditado em dinheirona sua
        conta cadastrada para compra de alimentos direto com os produtores
        credenciados.
      </h5>
    </S.Container>
  );
