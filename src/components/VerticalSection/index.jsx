...
const titles = {
    secondSectionHome:
        'Tenha produtos fresquinhos direto dos produtores familiares',
...
const subtitles = {
    secondSectionHome:
        'Toda semana ou quinzena uma cesta com frutas, legumes e verduras agroecológicos, frescos e da estação entregues na sua casa.',
    producers:
        'Conheça nossos produtores credenciados, são eles que produzem e levam o alimento até a sua mesa. Assinando com o Cestou você fortalece a produção de pequenos produtores da sua região e recebe alimentos frescos e cultivados com muito carinho e cuidado.',
    institutions:
        'Veja abaixo as instituições e projetos cadastrados na nossa rede e ajude-os a atingir a meta do mês doando suas moedas que serão convertidas em alimentos para pessoas em situação de fome.',
}
...
const imgsDescriptions = {
    ...
    institutions: [
        <div className="institutions-description">
            A ONG Comida Na Mesa leva o alimento para quem mais precisa através
            de mapeamento das pessoas em situação de fome e doação de alimentos
            para famílias carentes.
        </div>,
        <div className="institutions-description">
            A ONG Criança sem fome preza pela saúde e alimentação das crianças
            em risco de fome, dando suporte para as famílias, creches e escolas
            para alcançar o maior número de crianças possível.
        </div>,
    ],
}
