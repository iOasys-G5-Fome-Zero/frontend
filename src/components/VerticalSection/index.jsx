...
const imgsDescriptions = {
  ...
  institutions: [
    ...
    <div className="institutions-description">
      A ONG Criança sem fome preza pela saúde e alimentação das crianças em
      risco de fome, dando suporte para as famílias, creches e escolas para
      alcançar o maior número de crianças possível.
    </div>,
  ],
};
